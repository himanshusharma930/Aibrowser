---
created: 2025-11-11T09:58:36 (UTC +05:30)
tags: []
source: https://fellou.ai/eko/docs/getting-started/eko/
author: 
---
...
> ## Excerpt
> Eko (pronounced like “echo”) is a powerful framework designed for building production-ready Agent workflows.

---
![](https://fellou.ai/eko/docs/_astro/eko-colorful.Cf3lDsAa_Zvvc8f.webp)
...
![](https://fellou.ai/eko/docs/_astro/Fellouwithekov2_online_mind2web.Bllk5_2O_MQ4HI.webp)
...
Eko 2.0 achieves 80% success rate on the Online-Mind2web benchmark, compared to 31% for Eko 1.0. This performance improvement reflects the architectural enhancements and optimizations Fellou has implemented in the new version, making Eko 2.0 significantly more reliable for production workflows. ![](https://fellou.ai/eko/docs/_astro/Fellouwithekov2_Fellouwithekov1_Browseruse.BcBu90DX_Of62G.webp)
...
![ENVS](https://fellou.ai/eko/docs/_astro/envs.DR-uHsxW_Z1UoIuG.webp)

Learn more:

-   [Browser Extension Environment](https://fellou.ai/eko/docs/getting-started/eko/installation#browser-extension)
-   [Web Environment](https://fellou.ai/eko/docs/getting-started/eko/installation#web-environment)
-   [Node.js Environment](https://fellou.ai/eko/docs/getting-started/eko/installation#nodejs-environment)
-   [Next-Gen AI Browser Fellou Environment](https://fellou.ai/)

## Getting started

-   [Quickstart](https://fellou.ai/eko/docs/getting-started/eko/quickstart)
-   [Installation](https://fellou.ai/eko/docs/getting-started/eko/installation)
-   [Configuration](https://fellou.ai/eko/docs/getting-started/eko/configuration)
