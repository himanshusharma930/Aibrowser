              ...
              {tasks.map((task, index) => {
                ...
                return (
                  ...
                  >
                    {/* Task row */}
                    <motion.div
                      className="group flex items-center rounded-md px-3 py-2.5"
                      style={{
                        borderBottom: isExpanded && task.subtasks.length > 0 ? "1px solid rgba(255, 255, 255, 0.1)" : "none"
                      }}
                      whileHover={{
                        ...
                        <AnimatePresence mode="wait">
                          ...
                          >
                            {task.status === "completed" ? (
                              ...
                              <Circle className="h-4.5 w-4.5" style={{ color: "rgba(255, 255, 255, 0.5)" }} />
                            )}
                          </motion.div>
                        </AnimatePresence>
                      </motion.div>
                    ...
                    <AnimatePresence mode="wait">
                      {isExpanded && task.subtasks.length > 0 && (
                        ...
                        >
                          ...
                          <div 
                            className="absolute bottom-0 left-[20px] top-0 border-l-2 border-dashed" 
                            style={{ borderColor: "rgba(255, 255, 255, 0.2)" }}
                          />

                          <ul className="mb-1.5 ml-3 mr-2 mt-1 space-y-0.5" style={{ borderColor: "rgba(255, 255, 255, 0.1)" }}>
                              ...
                              return (
                                ...
                                >
                                      ...
                                      <AnimatePresence mode="wait">
                                        ...
                                        >
                                          {subtask.status === "completed" ? (
                                            ...
                                            <Circle className="h-3.5 w-3.5" style={{ color: "rgba(255, 255, 255, 0.5)" }} />
                                          )}
                                        </motion.div>
                                      </AnimatePresence>
                                    </motion.div>
                                  ...
                                  <AnimatePresence mode="wait">
                                    {isSubtaskExpanded && (
                                      <motion.div
                                        className="ml-1.5 mt-1 overflow-hidden border-l border-dashed pl-5 text-xs"
                                        style={{
                                          color: "rgba(255, 255, 255, 0.7)",
